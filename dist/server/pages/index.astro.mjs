...
const $$Loader = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a$2 || (_a$2 = __template$2(["", `<div id="loader" class="loader fixed inset-0 z-[100] bg-ink text-paper flex flex-col justify-between" role="status" aria-live="polite" aria-label="Loading" data-astro-cid-4qws3apc> <div class="flex items-center justify-between px-5 md:px-8 pt-6" data-astro-cid-4qws3apc> <span class="stamp text-xs text-paper/60" data-astro-cid-4qws3apc>N&deg;&nbsp;001 / STUDIO</span> <span class="stamp text-xs text-paper/60" data-astro-cid-4qws3apc>LOADING</span> </div> <div class="px-5 md:px-8 pb-8" data-astro-cid-4qws3apc> <div class="flex items-end justify-between border-t border-paper/20 pt-4" data-astro-cid-4qws3apc> <span class="font-display uppercase leading-none text-[18vw] md:text-[9vw]" data-astro-cid-4qws3apc> <span id="loader-count" data-astro-cid-4qws3apc>00</span><span class="text-accent" data-astro-cid-4qws3apc>%</span> </span> <span class="stamp text-xs text-paper/60 mb-2 hidden sm:block" data-astro-cid-4qws3apc>
PREPARING ASSETS
